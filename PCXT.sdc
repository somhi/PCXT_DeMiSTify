...
set_output_delay -clock { SDRAM_CLK } -max 2 [get_ports $RAM_OUT]
set_output_delay -clock { SDRAM_CLK } -min 1.5 [get_ports $RAM_OUT]




# set clk_100 ${topmodule}pll|altpll_component|auto_generated|pll1|clk[0]
